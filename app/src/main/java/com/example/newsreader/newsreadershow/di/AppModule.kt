package com.example.newsreader.newsreadershow.di

import android.content.Context
import com.example.newsreader.newsreadershow.data.api.NewsShowApiService
import com.example.newsreader.newsreadershow.data.api.SearchNewsApiService
import com.example.newsreader.newsreadershow.data.remote.NewsShowRemoteDataSource
import com.example.newsreader.newsreadershow.data.remote.SearchNewsDataRemote
import com.example.newsreader.newsreadershow.data.repository.NewsShowRepositoryImpl
import com.example.newsreader.newsreadershow.domain.repository.NewsShowRepository
import com.example.newsreader.newsreadershow.util.PreferencesManager
