...
import com.example.newsreader.newsreadershow.ui.viewmodel.NewsShowViewModel
...
@Composable
fun MainScreen(
    newsShowViewModel: NewsShowViewModel = hiltViewModel(),
            ...
            Box(modifier = Modifier.padding(innerPadding)) {
                ...
                PullToRefreshBox(
                    ...
                    LaunchedEffect(isRefreshing) {
                        if (isRefreshing) {
                            // 在这里模拟延迟，延迟 1 秒后更新 isRefreshing 为 false
                            delay(1000) // 延迟 1 秒
                        ...
                        items(
                            ...
                            if (item != null) {
                                if (item.url != "" && item.imgsrc != "") {
                                    NewsShowCard(item,navController)
                                }
                            }
                        }
